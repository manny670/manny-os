...
import { recalculateScheduleTimes, scoreAndRankGoals } from '../utils/scheduler.js';
...
export default function CheckInModal({
  ...
  useEffect(() => {
    if (isOpen) {
      if (initialValues) {
        setStartTime(initialValues.startTime || getCurrentTimeString());
  ...
  const startTimePresets = ['Now', '4:00 PM', '4:30 PM', '5:00 PM', '6:00 PM'];
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: 'var(--shadow-lg), 0 0 35px rgba(56, 189, 248, 0.12)',
          position: 'relative',
          overflow: 'hidden'
        }}
      >
        ...
        <div style={{ overflowY: 'auto', padding: '18px 24px 24px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            >
              {/* Start Time */}
              <div>
                <label style={{ display: 'block', fontSize: '0.72rem', color: 'var(--text-muted)', marginBottom: '3px', fontWeight: 600 }}>
                  Start Time
                </label>
              ...
              <div style={{ textAlign: 'right' }}>
                ...
                <div style={{ fontSize: '1.05rem', fontWeight: 800, color: 'var(--accent-primary)', fontFamily: 'var(--font-mono)' }}>
                  ...
                  {calculatedBlocks.map((b, idx) => (
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minWidth: 0 }}>
                        <span style={{ fontSize: '0.72rem', fontWeight: 700, color: 'var(--text-muted)', fontFamily: 'var(--font-mono)', width: '16px' }}>
                          {idx + 1}
                        </span>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '5px', flexShrink: 0 }}>
                        ...
                        <span style={{ fontSize: '0.74rem', fontWeight: 700, color: 'var(--accent-primary)', fontFamily: 'var(--font-mono)', minWidth: '38px', textAlign: 'center' }}>
            ...
            >
              ...
              {!selectedActivity ? (
                <div>
                  {/* Goals Section with Orbit Recommendations */}
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                    ...
                    <div style={{ fontSize: '0.68rem', color: 'var(--accent-primary)', display: 'flex', alignItems: 'center', gap: '3px' }}>
                      <Sparkles size={11} />
                      <span>Orbit Recommended highlighted</span>
                    </div>
                  </div>
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            padding: '10px 12px',
                            borderRadius: 'var(--radius-md)',
                            backgroundColor: isRec ? 'rgba(56, 189, 248, 0.08)' : 'var(--bg-card)',
                            border: isRec ? '1.5px solid var(--accent-primary)' : '1px solid var(--border-hairline)',
                            color: 'var(--text-primary)',
                            textAlign: 'left',
                            position: 'relative',
                            transition: 'all 0.16s ease',
                            boxShadow: isRec ? '0 0 14px rgba(56, 189, 248, 0.12)' : 'none'
                          }}
                          onMouseEnter={(e) => {
                          ...
                          onMouseLeave={(e) => {
                            e.currentTarget.style.borderColor = isRec ? 'var(--accent-primary)' : 'var(--border-hairline)';
                        ...
                        >
                          ...
                          <div style={{ minWidth: 0, flex: 1 }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                              <span style={{ fontSize: '0.84rem', fontWeight: 700, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                                {g.name}
                              </span>
                            </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span style={{ fontSize: '0.8rem', fontWeight: 600 }}>Custom Activity</span>
                    </button>
                  </div>
                </div>
              ) : (
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <span style={{ fontSize: '1.25rem' }}>{selectedActivity.icon}</span>
                      <div>
                  ...
                  <div style={{ marginBottom: '12px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(70px, 1fr))', gap: '5px', marginBottom: '6px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                      <span style={{ fontSize: '0.72rem', color: 'var(--text-muted)' }}>Or custom minutes:</span>
                      <input
                        type="number"
                        min="5"
                        max="240"
